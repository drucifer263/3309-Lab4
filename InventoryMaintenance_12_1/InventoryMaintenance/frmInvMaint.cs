...
namespace InventoryMaintenance
{
    public partial class frmInvMaint : Form
	{
        ...
        12-1
            ...
            Edited code that was given to us for this lab
            all my entries are below green lines
        ...
        */
		...
		private void btnAdd_Click(object sender, EventArgs e)
		{
            ...
            invItem = newItemForm.GetNewItem();
		...
		private void btnDelete_Click(object sender, EventArgs e)
		{
			...
			if (i != -1)
			{
               InvItem invItem = invItems[i];
                ...
                String message = "Are you certain you want to delete this entry: " + invItem.Description + " ?";
